...
import FormAddAnggaran from "./components/AddAnggaran";
import DataAnggaran from "./components/DataAnggaran";
...
export default function TargetPage() {
  ...
  // Only Advanced users can access Anggaran (budgets)
  if (userLevel?.toLowerCase() !== "advanced") {
    return (
      <LockedFeature 
        requiredLevel="Advanced" 
        featureName="Anggaran" 
        description="Alokasikan dana bulanan Anda secara disiplin dan otomatis per kategori pengeluaran."
      />
    );
  }
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-gray-500 dark:text-gray-400 font-bold text-sm tracking-wide">
              Alokasi dana yang terukur dan disiplin finansial yang dikurasi.
            </p>
          </div>
