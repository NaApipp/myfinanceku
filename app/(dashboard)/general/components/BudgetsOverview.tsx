        ...
        <div className="space-y-4">
          {[1, 2].map(i => (
            <div key={i} className="space-y-2">
              <div className="h-4 w-full bg-gray-50 dark:bg-white/5 rounded"></div>
      ...
      <div className="space-y-6 flex-1">
        {budgets.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-10 text-center">
             <div className="w-12 h-12 bg-gray-50 dark:bg-white/5 rounded-full flex items-center justify-center mb-3 text-gray-300 dark:text-gray-500">
               <PieChart className="w-6 h-6" />
             </div>
             <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Belum ada anggaran diatur</p>
          </div>
        ) : (
